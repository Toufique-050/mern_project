...
export default function Login() {
    const { login } = useAuth(),
        nav = useNavigate(), loc = useLocation(); const [email, setEmail] = useState(""),
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            nav(loc.state?.from || ({ admin: "/admin", organizer: "/organizer", participant: "/participant" }
            [d.user.role] || "/participant"),
                { replace: true })
        }
        catch (e) { setError(errorMessage(e, "Login failed. Check your email and password.")) }
    ...
    return (
        <main className="es-auth-page">
            <style>{`
                ...
                .es-field:nth-child(1) { animation-delay: 0.2s; }
                .es-field:nth-child(2) { animation-delay: 0.26s; }
                ...
                .es-field-label .forgot-link:hover {
                    color: #e29a4d;
                }
                ...
                .es-input-wrap svg.es-input-icon {
                    position: absolute;
                    left: 14px;
                    top: 50%;
                ...
                .es-field:focus-within .es-input-wrap svg.es-input-icon {
                    color: #e29a4d;
                ...
                .es-field input[type="text"].es-pw-visible {
                    padding-right: 42px;
                }

                /* Input status indicator */
                .es-field .input-status {
                    position: absolute;
                    right: 42px;
                    top: 50%;
                    transform: translateY(-50%);
                ...
                .es-submit {
                    ...
                    position: relative;
                    overflow: hidden;
                    animation: slideInRight 0.6s ease both 0.32s;
                }
                ...
                .es-divider {
                    ...
                    gap: 14px;
                    margin: 22px 0 18px;
                    animation: slideInRight 0.6s ease both 0.28s;
                }
                ...
                .es-switch {
                    ...
                    color: #7a7871;
                    margin: 20px 0 0;
                    animation: slideInRight 0.6s ease both 0.35s;
                }
                ...
                .es-demo-credentials {
                    ...
                    animation: slideInRight 0.6s ease both 0.38s;
                }

                .es-demo-credentials .demo-btn {
                    font-size: 10px;
                    font-weight: 500;
                    color: #8a8676;
                    background: rgba(226,154,77,0.06);
                ...
                .es-demo-credentials .demo-btn:hover {
                ...
                .es-demo-credentials .demo-btn .demo-label {
                    font-weight: 400;
                    color: #b5b0a4;
                }
            ...
            <div className="es-card">
                ...
                <h1>Welcome back</h1>
                <p className="subtitle">Sign in to continue to your EventSphere workspace.</p>
                ...
                <form onSubmit={submit}>
                    <div className="es-field">
                        <label className="es-field-label" htmlFor="email">
                            <span>Email</span>
                        </label>
                        <div className="es-input-wrap">
                            <div className="input-ripple" />
                            <svg className="es-input-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            ...
                            />
                            {email && (
                                <span className={`input-status visible`}>✅</span>
                            )}
                        </div>
                    </div>

                    <div className="es-field">
                        <label className="es-field-label" htmlFor="password">
                            <span>Password</span>
